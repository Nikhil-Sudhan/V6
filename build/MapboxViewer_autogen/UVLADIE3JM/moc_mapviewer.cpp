...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MapViewer_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MapViewer_t qt_meta_stringdata_MapViewer = {
    {
QT_MOC_LITERAL(0, 9) // "MapViewer"
...
const QMetaObject MapViewer::staticMetaObject = { {
    ...
    qt_meta_stringdata_MapViewer.offsetsAndSize,
    qt_meta_data_MapViewer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MapViewer_t
, QtPrivate::TypeAndForceComplete<MapViewer, std::true_type>
